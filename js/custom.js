...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ipip/query?key=9mMeky9xDUUJRo4GOJbTwg8ydC')
    .then(response => {
        if (!response.ok) {
...
function showWelcome() {
    ...
    let dist = getDistance(108.763612, 34.036821, ipLocation.data.lng, ipLocation.data.lat);
...
function cardTimes() {
  ...
  if (e) {
    ...
    const newYearDate = new Date("2026/08/30 00:00:00");
